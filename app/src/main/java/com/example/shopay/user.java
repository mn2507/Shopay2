...
public class user {
    ...
    public String getLast41() {
        return last41;
    }

    public void setLast41(String last41) {
        this.last41 = last41;
    }
    ...
    public static String fullname,password,username,address,city,state,zip,number, email, cusid,token, last4;

    public static String getLast4() {
        return last4;
    }

    public static void setLast4(String last4) {
        user.last4 = last4;
    }
